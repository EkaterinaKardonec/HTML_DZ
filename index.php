        ...
        <div class="w3-twothird">
            ...
            <div class="w3-container w3-card w3-white w3-margin-bottom">
                ...
                foreach ($work as $key => $item) {
                    ?>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b><?php echo $item['name'] ?></b></h5>
                        <h6 class="w3-text-teal"><i
                                    class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $item['date_start'] . ' - '; ?>
                            <?php if ($item['date_end'] == "текущищий момент") { ?>
                                <span class="w3-tag w3-teal w3-round"><?php echo $item['date_end']; ?></span>
                            <?php } else {
                                echo $item['date_end'];
                            } ?>
                        </h6>
                        <p><?php echo $item['text'] ?></p>
                        <?php if ($key != sizeof($work) - 1) {
                            ?>
                            <hr>
                        <?php } ?>
                    </div>
